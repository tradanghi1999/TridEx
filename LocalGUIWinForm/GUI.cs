...
namespace LocalGUIWinForm
{
    public partial class GUI : Form
    {
        ...
        public GUI(PreController.IController controller, PreController.ViewModel viewModel)
        {
            InitializeComponent();
        ...
        public void recieveFileViewModelsFromPresenter(List<PreController.FileViewModel> fvms)
        {
            //throw new NotImplementedException();
